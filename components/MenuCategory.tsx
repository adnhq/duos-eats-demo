...
export default function MenuCategory({ 
  ...
  return (
    <div className="space-y-6">
      <h2 className={`text-2xl font-bold mb-4 ${splineSans.className}`}>{category}</h2>
      <div className="space-y-4">
        {items.map((item) => (
          <div key={item.id} className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 p-4 bg-card rounded-lg shadow-sm">
